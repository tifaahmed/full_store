            ...
            <div class="row g-2">
                ...
                <div class="col-auto">
                    <button type="button" class="piker-button home_background_color" onclick="home_background_color_update('#99627A')">
                        <span class="s_color3  <?php echo e(@$settingdata->home_background_color == '#99627A' ? 'spanactive' : ''); ?>"></span>
                    </button>
                </div>
                <div class="col-auto">
                    <button type="button" class="piker-button home_background_color" onclick="home_background_color_update('#519259')">
                        <span class="s_color4  <?php echo e(@$settingdata->home_background_color == '#519259' ? 'spanactive' : ''); ?>"></span>
                    </button>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\Users\Jadara\Desktop\store\full_store\resources\views/admin/otherpages/colors.blade.php ENDPATH**/ ?>