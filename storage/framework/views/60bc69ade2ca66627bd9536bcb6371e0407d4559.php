...
<section  id="tab-category_<?php echo e($category->id); ?>" class="theme3pruductgrid px-0">
     ...
     <div id="product_items-<?php echo e($category->id); ?>" class="row border-bottom owl-carousel product-items  owl-theme" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">
...
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\laragon\www\full_store\full_store\resources\views/front/template-3/theme-slider.blade.php ENDPATH**/ ?>