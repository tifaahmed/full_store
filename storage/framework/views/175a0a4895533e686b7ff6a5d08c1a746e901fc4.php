...
<div id="branches" >
  ...
  <div class="row" id="peckup_branches_itemList" style="text-align: center;">
      <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="col-md-6 pickup_branches_item" data-lat="<?php echo e($branch->latitude); ?>" 
...
</script><?php /**PATH /home/mostafa/  pro/full_store/fullstore/resources/views/maps/google_maps_homepage_pickup.blade.php ENDPATH**/ ?>