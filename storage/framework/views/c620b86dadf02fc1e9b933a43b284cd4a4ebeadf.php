        ...
        <?php if(!$getcategory->isEmpty()): ?>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4 px-0">
                    <div class="card thme4categories dark">
                        ...
                        <div class="card-body <?php echo e(session()->get('direction') == 2 ? 'pe-2' : 'ps-2'); ?>">
                            <div class="text-section">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="favorite-icon1 px-0 set-fav1-<?php echo e($item->id); ?>">
                                        <?php if($item->is_favorite == 1): ?>
                                            <a href="javascript:void(0)" onclick="managefavorite('<?php echo e($storeinfo->id); ?>','<?php echo e($item->id); ?>',0,'<?php echo e(URL::to($storeinfo->slug.'/managefavorite')); ?>','<?php echo e(request()->url()); ?>')"><i class="fa-solid fa-heart fs-4"></i></a>
                                        <?php else: ?>
                                            <a href="javascript:void(0)" onclick="managefavorite('<?php echo e($storeinfo->id); ?>','<?php echo e($item->id); ?>',1,'<?php echo e(URL::to($storeinfo->slug.'/managefavorite')); ?>','<?php echo e(request()->url()); ?>')"><i class="fa-regular fa-heart fs-4"></i></a>
                                        <?php endif; ?>
                                    </div>
...
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/u182721273/domains/birds.re/public_html/resources/views/front/template-4/theme-list.blade.php ENDPATH**/ ?>