        ...
        <div class="col-12">
            <div class="card border-0 box-shadow">
                ...
                <i class="fa-solid fa-chart-pie fs-5"></i>
                    <h5 class="px-2"><?php echo e(trans('labels.facebook_pixel')); ?></h5>
                </div>
                <div class="card-body">
...
</div><?php /**PATH C:\laragon\www\full_store\full_store\resources\views/admin/facebook_pixel/facebook_pixel_form.blade.php ENDPATH**/ ?>