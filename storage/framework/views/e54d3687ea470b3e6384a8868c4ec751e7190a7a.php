<ul class="navbar-nav mx-3">
    ...
    <?php if(Auth::user()->type == 2): ?>
        ...
        <li class="nav-item mb-2 fs-7">
            ...
            <?php echo e(request()->is('admin/branches*') ? 'active' : ''); ?>" 
            aria-current="page" href="<?php echo e(URL::to('admin/branches')); ?>">
                <span class="<?php echo e(request()->is('admin/branches*') ? 'sidebariconbox' : 'sidebariconbox1'); ?>">
                    <i class="fa-solid fa-code-branch"></i>
                </span>
                <span class="px-2"><?php echo e(trans('labels.branches')); ?></span>
            </a>
        </li>
    ...
    <?php endif; ?>
</ul><?php /**PATH /home/mostafa/  pro/full_store/full_store/resources/views/admin/layout/sidebarcommon.blade.php ENDPATH**/ ?>