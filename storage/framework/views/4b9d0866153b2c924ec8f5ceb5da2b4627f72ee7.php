...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input   class="form-control input-h" id="mobile" name="mobile"  value="<?php echo e(old('mobile')); ?>" placeholder="<?php echo e(trans('labels.mobile')); ?> "  required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="password" class="form-control input-h" id="password" name="password"   placeholder="<?php echo e(trans('labels.password')); ?>"  required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <label for="password_confirmation" class="form-label"><?php echo e(trans('labels.password_confirmation')); ?><span class="text-danger"> * </span></label>
                                        <input type="password" class="form-control input-h" id="password_confirmation" name="password_confirmation"  placeholder="<?php echo e(trans('labels.password_confirmation')); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jadara\Desktop\store\full_store\resources\views/front/auth/register.blade.php ENDPATH**/ ?>