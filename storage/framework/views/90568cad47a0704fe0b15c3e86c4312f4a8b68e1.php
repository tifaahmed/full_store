        ...
        <div class="container">
            <nav class="px-2">
                ...
                <ol class="breadcrumb d-flex text-capitalize">
                    <li class="breadcrumb-item"><a href="<?php echo e(URL::to(@$storeinfo->slug)); ?>" class="text-white">
                            <?php echo e(trans('labels.home')); ?></a></li>
                    <li class="breadcrumb-item active <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>">
                        <?php echo e(trans('labels.my_cart')); ?></li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="container">
                <div class="py-4">
                    <div
                        ...
                        <div
                            class="col-md-12 col-lg-8 pb-4 px-0 <?php echo e(session()->get('direction') == 2 ? 'ps-lg-5 ' : 'pe-lg-5 '); ?>">
                            <div class="row align-items-center py-3">
                                ...
                                <?php $__currentLoopData = $cartdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="card my-cart-categories rounded-0 dark px-0">
                                            ...
                                            <div class="text-section">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="fs-7 fw-400 pointer text-center text-danger"
                                                        onclick="RemoveCart('<?php echo e($cart->id); ?>')">
                                                        <?php echo e(trans('labels.remove')); ?></p>
                                                </div>
                                                <?php if($cart->variants_id != '' || $cart->extras_id != ''): ?>
                                                    <a href="javascript:void(0)" class="customisable"
                                                        onclick="showextra('<?php echo e(@$cart->variants_name); ?>','<?php echo e(@$cart->variants_price); ?>','<?php echo e(@$cart->extras_name); ?>','<?php echo e(@$cart->extras_price); ?>','<?php echo e(@$cart->item_name); ?>')">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="price fs-6">
                                                        <?php echo e(helper::currency_formate($cart->qty * $cart->price, $storeinfo->id)); ?>
                        ...
                        <div class="col-md-12 col-lg-4 px-0">
                            <div class="card my-4 border p-3 rounded-4 shadow">
                                ...
                                <?php echo e(dd($grand_total , $storeinfo->minimum_price )); ?>
                                ...
                                <?php if( Auth::user() && Auth::user()->type == 3): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        href="<?php echo e(URL::to(@$storeinfo->slug . '/checkout')); ?>" >
                                            <?php echo e(trans('labels.checkout')); ?>
                    ...
                    <div class="row justify-content-between align-items-center g-2">
                        ...
                        <div class="col-md-6 md-mt-0">
                            ...
                            <a class="btn-primary w-100 text-center"
                                href="<?php echo e(URL::to(@$storeinfo->slug . '/checkout')); ?>"><?php echo e(trans('labels.continue_as_guest')); ?></a>
...
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mostafa/  pro/full_store/fullstore/resources/views/front/cart.blade.php ENDPATH**/ ?>