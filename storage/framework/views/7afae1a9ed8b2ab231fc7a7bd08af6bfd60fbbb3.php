...
<main>
     ...
     <section class="theme-1-margin-top">
          <div class="container">
               ...
               <?php echo $__env->make('front.template-5.theme-grid', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
               <?php else: ?>
               <?php echo $__env->make('front.template-5.theme-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
               <?php endif; ?>
     </section>
     <?php endif; ?>
...
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/full_store/resources/views/front/template-5/index.blade.php ENDPATH**/ ?>