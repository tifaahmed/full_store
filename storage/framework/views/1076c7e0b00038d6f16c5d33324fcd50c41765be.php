...
<?php
  $web_footer_color = isset($storeinfo->setting) ? $storeinfo->setting->web_footer_color : $storeinfo->web_footer_color;
?>
<footer class="mt-25" style="background-color: <?php echo e($web_footer_color); ?>;">
    <div class="container">
        <div class="row pt-5">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-md-4 mb-lg-0">
                ...
                <p  class="footersubtitle fff"> <?php echo e(helper::appdata($storeinfo->id)->description); ?></p>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="row justify-content-center justify-content-center">
                    ...
                    <div class="col-md-12 col-12 mb-md-0 px-0 ">
                        <h5 class="footer-title fff"> <?php echo e(trans('labels.infromation')); ?></h5>
                        <ul class="footer-right-side">
                            <li>
                                <i class="fa-solid fa-location-dot"></i>
                                <span>
                                    <a class="fff" href="https://www.google.com/maps/place/323/<?php echo e(helper::appdata($storeinfo->id)->address); ?>"
                            ...
                            <li>
                                ...
                                <span class="px-2">
                                    <a href="#" href="#" data-bs-toggle="modal" data-bs-target="#examplehours" class="fff"
                                        data-bs-whatever="@mdo"><?php echo e(trans('labels.hours')); ?></a>
                                </span>
                            </li>
                            <li>
                                <i class="fa-solid fa-headphones"></i>
                                <span class="px-2"> <a class="fff"
                                        href="tel:<?php echo e(helper::appdata($storeinfo->id)->contact); ?>"><?php echo e(helper::appdata($storeinfo->id)->contact); ?></a>
                                </span>
                            </li>
                            <li>
                                <a class="fff" href="<?php echo e(URL::to(@$storeinfo->slug . '/privacypolicy')); ?>" class="mb-3">
                                    <?php echo e(trans('labels.privacy_policy')); ?>

                                </a>
                            </li>
                            <li>
                                <a class="fff" href="<?php echo e(URL::to(@$storeinfo->slug . '/terms_condition')); ?>" class="mb-3">
                                    <?php echo e(trans('labels.terms')); ?>
                            ...
                            <li>
                                <a class="fff" href="<?php echo e(URL::to(@$storeinfo->slug . '/refundprivacypolicy')); ?>" class="mb-3">
                                    <?php echo e(trans('labels.refund_policy')); ?>
                            ...
                            <li>
                                ...
                                <span class="px-2">
                                    <a class="fff"  href="mailto:<?php echo e(helper::appdata($storeinfo->id)->email); ?>">
...
<?php /**PATH /home/mostafa/  pro/full_store/fullstore/resources/views/front/theme/footer.blade.php ENDPATH**/ ?>