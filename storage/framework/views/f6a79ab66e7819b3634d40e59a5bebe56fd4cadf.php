...
<div class="row g-3 mb-7">
    ...
    <?php $__currentLoopData = $getpayment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pmdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-md-12 col-lg-12 col-xl-6 
            ...
            <?php echo e($transaction_type == 'banktransfer' && Auth::user()->type == 2 ? 'd-none' : ''); ?>">
                    ...
                    <div class="card-header bg-transparent">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                value="1" <?php echo e($pmdata->is_available == 1 ? 'checked' : ''); ?>>
                        ...
                        <div class="row">
                            ...
                            <?php if(!in_array($transaction_type,['cod'])): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="bank_name" class="form-label"> 
                                            <?php echo e(trans('labels.bank_name')); ?> <span class="text-danger"> *</span>
                                        </label>
                                        <input type="text" required="" id="bank_name" class="form-control" 
                                        name="bank_name" placeholder="<?php echo e(trans('labels.bank_name')); ?>" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="account_holder_name" class="form-label"> 
                                            <?php echo e(trans('labels.account_holder_name')); ?> <span class="text-danger"> *</span>
                                        </label>
                                        <input type="text" required="" id="account_holder_name" class="form-control" 
                                        name="account_holder_name" placeholder="<?php echo e(trans('labels.account_holder_name')); ?>" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="account_number" class="form-label"> 
                                            <?php echo e(trans('labels.account_number')); ?> <span class="text-danger"> *</span>
                                        </label>
                                        <input type="text" required="" id="account_number" class="form-control" 
                                        name="account_number" placeholder="<?php echo e(trans('labels.account_number')); ?>" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="bank_ifsc_code" class="form-label"> 
                                            <?php echo e(trans('labels.bank_ifsc_code')); ?> <span class="text-danger"> *</span>
                                        </label>
                                        <input type="text" required="" id="bank_ifsc_code" class="form-control" 
                                        name="bank_ifsc_code" placeholder="<?php echo e(trans('labels.bank_ifsc_code')); ?>" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="form-check form-check-inline">
                                            ...
                                            value="1" <?php echo e($pmdata->environment == 1 ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check form-check-inline mx-3">
                                            ...
                                            value="2" <?php echo e($pmdata->environment == 2 ? 'checked' : ''); ?>>
                                ...
                                <?php if($transaction_type == 'flutterwave'): ?>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo e($pmdata->encryption_key); ?>" <?php echo e($transaction_type == 'flutterwave' ? 'required' : ''); ?>>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="col-md-6 <?php echo e($transaction_type == 'mercadopago' || $transaction_type == 'myfatoorah' ? 'd-none' : ''); ?>">
                                    <div class="form-group">
                                        ...
                                        <?php echo e($transaction_type != 'mercadopago' || $transaction_type != 'myfatoorah' ? 'required' : ''); ?>>
                                    </div>
                                </div>
                                <?php endif; ?>
                            <?php endif; ?>
                            ...
                            <div class="col-md-6 d-flex justify-content-end align-items-end">
                                <div class="form-group text-end">
                                    <button class="btn btn-success btn-succes m-1" <?php if(env('Environment')=='sendbox' ): ?> 
                                    type="button" onclick="myFunction()" <?php else: ?> type="submit" <?php endif; ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mostafa/  pro/full_store/full_store/resources/views/admin/payment/payment.blade.php ENDPATH**/ ?>