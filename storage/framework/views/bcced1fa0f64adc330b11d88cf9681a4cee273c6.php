...
<?php if($check_cat_count > 0): ?>
        ...
        <div class="specs theme1grid <?php if($check_cat_count > 0 && $key != 0): ?> card-none <?php endif; ?>" id="specs-<?php echo e($category->id); ?>">
            <div id="product_items-<?php echo e($category->id); ?>" class="row g-2 g-md-3  owl-carousel product-items  owl-theme" >
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\Users\Jadara\Desktop\store\full_store\resources\views/front/template-2/theme-slider.blade.php ENDPATH**/ ?>