    ...
    <div class="row mb-7">
        <div class="col-12">
            <div class="card border-0 box-shadow">
                <div class="card-body">
                    <form action="<?php echo e(URL::to('admin/branches/update/' . $branch->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="form-group row">
                                <div class="col-12 col-md-6">
                                    ...
                                    value="<?php echo e(old('name.ar')?? ( isset( $branch->getTranslations('name')['ar'] ) ? $branch->getTranslations('name')['ar'] : ''  )); ?>" 
...
unset($__errorArgs, $__bag); ?> 
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    value="<?php echo e(old('name.en')?? ( isset( $branch->getTranslations('name')['en'] ) ? $branch->getTranslations('name')['ar'] : ''  )); ?>" 
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="deliveryarea_id" class="form-select" required>
                                        ...
                                        <?php $__currentLoopData = $deliveryAreas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $deliveryArea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($branch->deliveryarea_id == $key): echo 'selected'; endif; ?>>
                                                <?php echo e($deliveryArea); ?>  
                                            </option>
...
unset($__errorArgs, $__bag); ?> 
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    value="1"  <?php echo e($branch->is_active  ? 'checked' : ''); ?>>
                            ...
                            <div class="form-group text-end">
                                <a href="<?php echo e(URL::to('admin/area')); ?>" class="btn btn-danger btn-cancel m-1"><?php echo e(trans('labels.cancel')); ?></a>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mostafa/  pro/full_store/full_store/resources/views/admin/branch/edit.blade.php ENDPATH**/ ?>