                ...
                <form action="<?php echo e(URL::to('admin/products/save')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 form-group">
                            <label class="form-label"><?php echo e(trans('labels.name_ar')); ?> <span class="text-danger"> * </span></label>
                            <input type="text" class="form-control" name="item_name[ar]" value="<?php echo e(old('item_name.ar')); ?>" placeholder="<?php echo e(trans('labels.name_ar')); ?>" required>
                            <?php if($errors->has('item_name.ar')): ?>
                            <div class="alert alert-danger"><?php echo e($errors->first('item_name.ar')); ?></div>
                            <?php endif; ?>
                        </div>
                        <?php echo e(old('item_name.ar')); ?>

                        <div class="col-12 col-lg-6 form-group">
                            <label class="form-label"><?php echo e(trans('labels.name_en')); ?> <span class="text-danger"> * </span></label>
                            <input type="text" class="form-control" name="item_name[en]" value="<?php echo e(old('item_name.en')); ?>" placeholder="<?php echo e(trans('labels.name_ar')); ?>" required>
                            <?php if($errors->has('item_name.en')): ?>
                            <div class="alert alert-danger"><?php echo e($errors->first('item_name.en')); ?></div>
                            <?php endif; ?>
                        </div>
                        <div class="col-12 col-lg-6 form-group">
                            <label class="form-label"><?php echo e(trans('labels.description_ar')); ?> <span class="text-danger"> * </span></label>
                            <textarea name="description[ar]" class="form-control" rows="3" placeholder="<?php echo e(trans('labels.description_ar')); ?>" required><?php echo e(old('description.ar')); ?></textarea>
                            <?php if($errors->has('description.ar')): ?>
                            <div class="alert alert-danger"><?php echo e($errors->first('description.en')); ?></div>
                            <?php endif; ?>
                        </div>
                        <div class="col-12 col-lg-6 form-group">
                            <label class="form-label"><?php echo e(trans('labels.description_en')); ?> <span class="text-danger"> * </span></label>
                            <textarea name="description[en]" class="form-control" rows="3" placeholder="<?php echo e(trans('labels.description_en')); ?>" required><?php echo e(old('description.en')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mt-4 dn <?php if($errors->has('variation.*') || $errors->has('variation_price.*') || old('has_variants') == 1): ?> d-flex <?php endif; ?>" id="variations">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="col-form-label"><?php echo e(trans('labels.variation_ar')); ?> 
                                            <span class="text-danger"> * </span>
                                        </label>
                                        <input type="text" class="form-control variation" name="variation[0][ar]" 
                                        placeholder="<?php echo e(trans('labels.variation_ar')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="col-form-label"><?php echo e(trans('labels.variation_en')); ?> 
                                            <span class="text-danger"> * </span>
                                        </label>
                                        <input type="text" class="form-control variation" name="variation[0][en]" 
                                        placeholder="<?php echo e(trans('labels.variation_en')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="extras_name[0][ar]" placeholder="<?php echo e(trans('labels.name_ar')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="col-form-label"><?php echo e(trans('labels.name_en')); ?></label>
                                        <input type="text" class="form-control" name="extras_name[0][en]" placeholder="<?php echo e(trans('labels.name_en')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button class="btn btn-success btn-sm rounded-5 ms-2" type="button" 
                                            onclick="extras_fields('<?php echo e(trans('labels.name_ar')); ?>','<?php echo e(trans('labels.name_en')); ?>','<?php echo e(trans('labels.price')); ?>')">
                                                <i class="fa-sharp fa-solid fa-plus"></i> 
                                            </button>
                                        </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mostafa/  pro/full_store/fullstore/resources/views/admin/product/add_product.blade.php ENDPATH**/ ?>