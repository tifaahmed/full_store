                            ...
                            <form action="<?php echo e(URL::to($storeinfo->slug . '/change_password/')); ?>" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <input type="email" class="form-control input-h" id="email" name="email"  value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(trans('labels.email')); ?> "  required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <label for="name" class="form-label"><?php echo e(trans('labels.name')); ?> </label>
                                        <input   class="form-control input-h" id="name" name="name"  value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(trans('labels.name')); ?> "  required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <label for="phone" class="form-label"><?php echo e(trans('labels.phone')); ?><span class="text-danger"> * </span></label>
                                        <input   class="form-control input-h" id="phone" name="phone"  value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(trans('labels.phone')); ?> "  required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="password" class="form-control input-h" id="password" name="password" value="<?php echo e(old('password')); ?>" placeholder="<?php echo e(trans('labels.password')); ?>"  required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <label for="confirm_password" class="form-label"><?php echo e(trans('labels.confirm_password')); ?><span class="text-danger"> * </span></label>
                                        <input type="password" class="form-control input-h" id="confirm_password" name="confirm_password" id="validationDefault" value="" placeholder="<?php echo e(trans('labels.confirm_password')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-12 d-flex justify-content-end">
                                        ...
                                        style="width: 100%;">
                                            <?php echo e(trans('labels.register')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\full_store\full_store\resources\views/front/auth/register.blade.php ENDPATH**/ ?>