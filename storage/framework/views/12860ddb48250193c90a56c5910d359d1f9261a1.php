                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-list-group">
                            <ul class="list-group list-group-flush">
                                ...
                                <?php if($getorderdata->is_delivery_now ): ?>
                                <li class="list-group-item px-0 d-flex justify-content-between">
                                    delivery options
                                    <p class="text-muted"><?php echo e($getorderdata->is_delivery_now ?  'delivery now' :'delivery in specific date & time '); ?></p>
                                </li>
                                <?php endif; ?>
                            ...
                            <div class="row">
                                <div class="basic-list-group">
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <?php endif; ?>
                                        <?php if($getorderdata->order_notes != null): ?>
                                        <li class="list-group-item px-0 d-flex justify-content-between">
                                            <p><?php echo e(trans('labels.notes')); ?></p>
                                            <p class="text-muted"><?php echo e($getorderdata->order_notes); ?></p>
                                        </li>
                                        <?php endif; ?>
                ...
                <div class="card border-0 mb-3 h-100 d-flex">
                    <div class="card-header d-flex align-items-center bg-transparent text-dark py-3">
                        ...
                        <h5 class="px-2 fw-500">
                            ...
                            <?php else: ?>
                                <?php echo e(trans('labels.delivery_info')); ?>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="basic-list-group">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <p><?php echo e(trans('labels.delivery_area')); ?></p>
                                                    <p class="text-muted"><?php echo e($getorderdata->delivery_area); ?></p>
                                                </li>
                                                
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <p><?php echo e(trans('labels.address')); ?> ar </p>
                                                    <p class="text-muted"> 
                                                        <?php echo e(isset( json_decode($getorderdata->address , true)['ar'] ) ?  json_decode($getorderdata->address , true)['ar']:''); ?>.</p>
                                                </li>
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <p><?php echo e(trans('labels.address')); ?> en </p>
                                                    <p class="text-muted"> 
                                                        <?php echo e(isset( json_decode($getorderdata->address , true)['en'] ) ?  json_decode($getorderdata->address , true)['en']  :''); ?>.</p>
                                                </li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
...
<?php if($getorderdata->latitude && $getorderdata->longitude): ?>
    <div class="row mt-4">
        <div class="col-md-12">
            ...
            <br>
            <a href="https://www.google.com/maps/search/?api=1&query=<?php echo e($getorderdata->latitude); ?>,<?php echo e($getorderdata->longitude); ?>" target="_blank">
                https://www.google.com/maps/search/?api=1&query=<?php echo e($getorderdata->latitude); ?>,<?php echo e($getorderdata->longitude); ?>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mostafa/  pro/full_store/fullstore/resources/views/admin/orders/invoice.blade.php ENDPATH**/ ?>