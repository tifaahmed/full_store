...
<div id="<?php echo e($category->slug); ?>">
     ...
     <div id="product_items-<?php echo e($category->id); ?>" class="row theme-4-gridproduct-card g-2 g-md-3 owl-carousel product-items  owl-theme">
                               ...
                               <div class="row justify-content-between align-items-center gx-0">
                                   ...
                                   <div class="col-3 col-md-2 d-flex justify-content-end px-2 mb-2 mb-md-0">
                                       ...
                                       <?php else: ?>
                                           ...
                                           <a type="button" class="btn-plus-1 addcartbtn-<?php echo e($item->id); ?>"  onclick="addtocart('<?php echo e($item->id); ?>','<?php echo e($item->item_name); ?>','<?php echo e($item->item_price); ?>','<?php echo e($image); ?>','<?php echo e($item->tax); ?>','1','<?php echo e($item->item_price); ?>')">
...
<?php endif; ?>
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\Users\Jadara\Desktop\store\full_store\resources\views/front/template-4/theme-slider.blade.php ENDPATH**/ ?>