            ...
            <div class="col-md-12 col-lg-9">
                <div class="card shadow border-0 rounded-5">
                    <div class="card-body py-4">
                        ...
                        <form action="<?php echo e(URL::to($storeinfo->slug . '/user-address/'.$address->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <?php if(old('labels.is_active') || $address->is_active): echo 'checked'; endif; ?> >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    id="validationDefault" value="<?php echo e(old('labels.title') ?? $address->title); ?>" placeholder="<?php echo e(trans('labels.title')); ?> "  
                                    required>
                                    ...
                                    <div>
                                        <?php $__currentLoopData = $address_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $address_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-check form-check-inline">
                                                ...
                                                <?php echo e(old('type') == $key || $address->type == $key  ? 'checked' : ''); ?> />
...
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\full_store\full_store\resources\views/front/user-address/edit.blade.php ENDPATH**/ ?>