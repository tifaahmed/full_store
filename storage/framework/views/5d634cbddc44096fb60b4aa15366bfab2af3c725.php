...
<script src="<?php echo e(asset('js/maps_draw_show.js')); ?>"></script>
<?php /**PATH C:\laragon\www\full_store\full_store\resources\views/maps/google_map_draw_show.blade.php ENDPATH**/ ?>