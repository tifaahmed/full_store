                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="form-label">
                                                            <?php echo e(trans('labels.currency_symbol')); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label class="form-label">
                                                            <?php echo e(trans('labels.minimum_price')); ?>

                                                            <span class="text-danger"> * </span>
                                                        </label>
                                                        <input type="number" step="0.1" class="form-control" name="minimum_price" 
                                                        value="<?php echo e(@$settingdata->minimum_price); ?>" 
                                                        placeholder="<?php echo e(trans('labels.minimum_price')); ?>" required>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mostafa/  pro/full_store/fullstore/resources/views/admin/otherpages/settings.blade.php ENDPATH**/ ?>