            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-12">
                    <div class="banner-content me-xl-5 me-lg-3 me-md-2">
                        ...
                        data-type='["<?php echo e(__("landing.hero_banner_title")); ?>", "<?php echo e(__("landing.hero_banner_title")); ?>"]'>
                        ...
                        <div class="input-group mb-lg-4 mb-3">
                            <a href="<?php echo e(URL::to('/admin')); ?>" class="ctm-btn2" target="_blank"><span class="m-0  fs-6"><?php echo e(trans('landing.get_started')); ?> <i class="bi bi-arrow-right"></i> </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row pg-none">
                <div class="col-xl-4 pg-none col-lg-4 d-none d-lg-block">
                    <div class="img-works-new">
                        <img src="<?php echo e(url(env('ASSETSPATHURL').'landing/images/w1.png')); ?>" alt="w1">
                        <img src="<?php echo e(url(env('ASSETSPATHURL').'landing/images/w2.png')); ?>" alt="w2">
                    </div>
                </div>
                    ...
                    <div class="row ms-xl-5 ms-lg-4">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12 mb-4 mb-md-0">
                                <div class="card  items-work h-100 border-0 rounded-0 pb-xl-5">
                                    ...
                                    <div class="card-body p-0 ms-3">
                                        <div class="border-start border-2 border-secondary-color ps-4 mb-xl-4 mb-lg-3">
                                            <h4 class="card-title"><?php echo e(trans('landing.how_it_work_step_two')); ?></h4>
                                            <p class="card-text fs-7 text-truncate-2 text-muted"><?php echo e(trans('landing.how_it_work_step_two_description')); ?></p>
                                        </div>
                                    </div>
                                    <div class="card-footer border-0 bg-transparent">
                                        <a href="<?php echo e(URL::to('/admin')); ?>" class="border-bottom ms-4 fw-500 ms-lg-0 ms-xl-4" target="_blank"><?php echo e(trans('landing.get_started')); ?></a>
        ...
        <div class="card-section-bg-color pb-5">
            <div class="container card-section-container">
                        ...
                        <a href="<?php echo e(URL::to($user->slug . '/')); ?>" target="_blank">
                            <div class="sub-partners">
                                ...
                                <div class="text-partners">
                                    <h2><?php echo e($user->website_title); ?></h2>
                ...
                <div class="d-flex justify-content-center mt-4">
                    <a href="<?php echo e(URL::to('stores')); ?>" class="ctm-btn2"><?php echo e(trans('landing.see_all')); ?> <i class="fa-solid <?php echo e(session()->get('direction') == 2 ? 'fa-arrow-left' : 'fa-arrow-right'); ?> px-2"></i></a>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('landing.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jadara\Desktop\store\full_store\resources\views/landing/index.blade.php ENDPATH**/ ?>