<nav aria-label="breadcrumb">
    ...
    <ol class="breadcrumb breadcrumb-rtl">
        ...
        <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>" 
        aria-current="page">
        ...
        <?php if(request()->is('admin/branches')): ?>
            <li class="breadcrumb-item active 
            <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>" 
            aria-current="page">
                <?php echo e(trans('labels.branches')); ?>

            </li>
        <?php endif; ?>
        <?php if(request()->is('admin/branches/add*') || request()->is('admin/branches/show*')): ?>
            <li class="breadcrumb-item active 
            <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>" 
            aria-current="page"><a href="<?php echo e(URL::to('admin/branches')); ?>">
                <?php echo e(trans('labels.branches')); ?></a>
            </li>
            <li class="breadcrumb-item active 
            <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>" 
            aria-current="page">
                <?php if(request()->is('admin/branches/show*')): ?>
                    <?php echo e(trans('labels.edit')); ?>
...
</nav><?php /**PATH /home/mostafa/  pro/full_store/full_store/resources/views/admin/layout/breadcrumb.blade.php ENDPATH**/ ?>