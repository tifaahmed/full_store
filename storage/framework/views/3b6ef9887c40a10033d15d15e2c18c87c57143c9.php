...
<script src="<?php echo e(url(env('ASSETSPATHURL') . 'admin-assets/js/pos_cartview.js')); ?>" type="text/javascript"></script><?php /**PATH /home/mostafa/small_store/new_full_store/resources/views/admin/pos/cartview.blade.php ENDPATH**/ ?>