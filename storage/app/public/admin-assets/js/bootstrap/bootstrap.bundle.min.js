...
!(function(t, e) {
        ...
        ? (function(t, e, i) {
            return function n(s) {
              ...
              for (let { target: r } = s; r && r !== this; r = r.parentNode)
                for (const a of o)
                  if (a === r)
                    return j(s, { delegateTarget: r }), n.oneOff &&
                      P.off(t, s.type, e, i), i.apply(r, [s]);
            };
          })(t, i, r)
        : (function(t, e) {
            return function i(n) {
              return j(n, { delegateTarget: t }), i.oneOff &&
                P.off(t, n.type, e), e.apply(t, [n]);
            };
          })(t, r);
  ...
  const P = {
    ...
    trigger(t, e, i) {
      ...
      return (l = j(l, i)), a && l.preventDefault(), r &&
  ...
  const B = {
    ...
    getDataAttributes(t) {
      ...
      for (const n of i) {
        let i = n.replace(/^bs/, "");
        (i = i.charAt(0).toLowerCase() + i.slice(1, i.length)), (e[i] = $(
          t.dataset[n]
        ));
      }
      return e;
  ...
  class U extends F {
    ...
    _end(t) {
      this._eventIsPointerPenTouch(t) &&
        (this._deltaX =
          t.clientX -
          this._deltaX), this._handleSwipe(), m(this._config.endCallback);
    }
    _move(t) {
      this._deltaX =
  ...
  class at extends z {
    constructor(t, e) {
      super(
        t,
        e
      ), (this._interval = null), (this._activeElement = null), (this._isSliding = !1), (this.touchTimeout = null), (this._swipeHelper = null), (this._indicatorsElement = Q.findOne(".carousel-indicators", this._element)), this._addEventListeners(), this._config.ride === it && this.cycle();
    }
    static get Default() {
      return ot;
    }
    ...
    _addEventListeners() {
      this._config.keyboard &&
        P.on(this._element, "keydown.bs.carousel", t =>
          this._keydown(t)
        ), "hover" === this._config.pause && (P.on(this._element, "mouseenter.bs.carousel", () => this.pause()), P.on(this._element, "mouseleave.bs.carousel", () => this._maybeEnableCycle())), this._config.touch && U.isSupported() && this._addTouchEventListeners();
    }
    ...
    _slide(t, e = null) {
      ...
      s.classList.add(
        ...
        () => {
          s.classList.remove(l, c), s.classList.add(nt), i.classList.remove(
            nt,
            c,
            l
          ), (this._isSliding = !1), r(et);
        },
        i,
        this._isAnimated()
      ), a && this.cycle();
  ...
  class pt extends z {
    ...
    show() {
      ...
      this._element.classList.remove(
        ct
      ), this._element.classList.add(ht), (this._element.style[e] = 0), this._addAriaAndCollapsedClass(this._triggerArray, !0), (this._isTransitioning = !0);
      const i = `scroll${e[0].toUpperCase() + e.slice(1)}`;
      this._queueCallback(
        () => {
          (this._isTransitioning = !1), this._element.classList.remove(
            ht
          ), this._element.classList.add(ct, lt), (this._element.style[e] =
    ...
    hide() {
      ...
      (this._element.style[t] = `${this._element.getBoundingClientRect()[
        t
      ]}px`), d(this._element), this._element.classList.add(ht), this._element.classList.remove(ct, lt);
      ...
      (this._isTransitioning = !0), (this._element.style[t] = ""), this._queueCallback(
        () => {
          (this._isTransitioning = !1), this._element.classList.remove(
            ht
          ), this._element.classList.add(ct), P.trigger(
            this._element,
            "hidden.bs.collapse"
          );
        },
  ...
  const qt = {
    ...
    effect: function(t) {
      ...
      return Object.assign(e.elements.popper.style, i.popper), (e.styles = i), e
        .elements.arrow &&
  ...
  function te(t) {
    return ((Ft(t) ? t.ownerDocument : t.document) ||
  ...
  function de(t) {
    ...
    if (c) {
      ...
      A === Bt(i) &&
        ...
        "absolute" === a &&
        ((E = "scrollHeight"), (T = "scrollWidth")), (s === gt ||
        ((s === bt || s === _t) && o === At)) &&
        (
          (y = mt),
          (g -=
    ...
    var C,
      ...
      x =
        !0 === h
          ...
          : { x: f, y: g };
    return (f =
      x.x), (g = x.y), l ? Object.assign({}, O, (((C = {})[y] = b ? "0" : ""), (C[v] = _ ? "0" : ""), (C.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + f + "px, " + g + "px)" : "translate3d(" + f + "px, " + g + "px, 0)"), C)) : Object.assign({}, O, (((e = {})[y] = b ? g + "px" : ""), (e[v] = _ ? f + "px" : ""), (e.transform = ""), e));
  }
  const ue = {
    name: "computeStyles",
    enabled: !0,
  ...
  function Ce(t, e) {
    return e === Tt
      ...
      : Ft(e)
        ? (function(t) {
            var e = Yt(t);
            return (e.top = e.top + t.clientTop), (e.left =
              e.left + t.clientLeft), (e.bottom =
              e.top + t.clientHeight), (e.right =
              e.left + t.clientWidth), (e.width = t.clientWidth), (e.height =
              t.clientHeight), (e.x = e.left), (e.y = e.top), e;
          })(e)
        : Te(
            (function(t) {
              var e,
        ...
        var n =
          ...
          r = s.reduce(function(e, i) {
            ...
            return (e.top = Kt(
              n.top,
              e.top
            )), (e.right = Qt(n.right, e.right)), (e.bottom = Qt(n.bottom, e.bottom)), (e.left = Kt(n.left, e.left)), e;
          }, Ce(t, o));
        return (r.width = r.right - r.left), (r.height =
          r.bottom - r.top), (r.x = r.left), (r.y = r.top), r;
        ...
        h = {
          ...
          setOptions: function(i) {
            ...
            d(), (a.options = Object.assign(
              ...
              reference: Ft(t)
                ? Ee(t)
                : t.contextElement ? Ee(t.contextElement) : [],
              popper: Ee(e)
            });
            var r,
              c,
            ...
            if (!c) {
              ...
              if (We(e, i)) {
                (a.rects = {
                  ...
                  a.options.placement), a.orderedModifiers.forEach(function(t) {
  ...
  class li extends z {
    constructor(t, e) {
      super(
        t,
        e
      ), (this._popper = null), (this._parent = this._element.parentNode), (this._menu = Q.findOne(Ze, this._parent)), (this._inNavbar = this._detectNavbar());
    }
    static get Default() {
      return ri;
    }
    ...
    show() {
      ...
      if (!P.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
        ...
        this._element.focus(), this._element.setAttribute(
          "aria-expanded",
          !0
        ), this._menu.classList.add(Ue), this._element.classList.add(
          Ue
    ...
    _completeHide(t) {
      if (!P.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented) {
        ...
        this._popper && this._popper.destroy(), this._menu.classList.remove(
          Ue
        ), this._element.classList.remove(Ue), this._element.setAttribute(
          "aria-expanded",
          "false"
        ), B.removeDataAttribute(this._menu, "popper"), P.trigger(
          this._element,
          "hidden.bs.dropdown",
          t
        );
  ...
  P.on(
    ...
    Ye,
    Ge,
    li.dataApiKeydownHandler
  ), P.on(document, Ye, Ze, li.dataApiKeydownHandler), P.on(document, Xe, li.clearMenus), P.on(document, "keyup.bs.dropdown.data-api", li.clearMenus), P.on(
    document,
    Xe,
    Ge,
    function(t) {
  ...
  class fi {
    ...
    reset() {
      this._resetElementAttributes(
        this._element,
        "overflow"
      ), this._resetElementAttributes(this._element, di), this._resetElementAttributes(ci, di), this._resetElementAttributes(hi, ui);
    }
    isOverflowing() {
  ...
  class bi extends F {
    ...
    show(t) {
      ...
      this._config.isAnimated &&
        d(e), e.classList.add(pi), this._emulateAnimation(() => {
        m(t);
      });
    }
    hide(t) {
  ...
  class Si extends z {
    constructor(t, e) {
      super(
        t,
        e
      ), (this._dialog = Q.findOne(".modal-dialog", this._element)), (this._backdrop = this._initializeBackDrop()), (this._focustrap = this._initializeFocusTrap()), (this._isShown = !1), (this._isTransitioning = !1), (this._scrollBar = new fi()), this._addEventListeners();
    }
    static get Default() {
      return Li;
    }
    ...
    _showElement(t) {
      ...
      e &&
        (e.scrollTop = 0), d(this._element), this._element.classList.add(xi), this._queueCallback(
        () => {
          this._config.focus &&
            this._focustrap.activate(), (this._isTransitioning = !1), P.trigger(
            this._element,
            "shown.bs.modal",
            { relatedTarget: t }
          );
      ...
      (this._element.style.display =
        ...
        () => {
          document.body.classList.remove(
            Oi
          ), this._resetAdjustments(), this._scrollBar.reset(), P.trigger(
            this._element,
            Ti
          );
        }
          ...
          this._queueCallback(
            () => {
              (this._config.scroll && !this._config.backdrop) ||
                ...
                Ii
              ), this._element.classList.remove(Ni), P.trigger(
                this._element,
                "shown.bs.offcanvas",
                { relatedTarget: t }
              );
            ...
            this._queueCallback(
              () => {
                this._element.classList.remove(
                  ...
                  new fi().reset(), P.trigger(this._element, Hi);
              },
              this._element,
              !0
            )
  ...
  P.on(
    ...
    function(t) {
      ...
      i && i !== e && Bi.getInstance(i).hide(), Bi.getOrCreateInstance(
        e
      ).toggle(this);
    }
  ...
  class an extends z {
    constructor(t, e) {
      ...
      super(
        t,
        e
      ), (this._isEnabled = !0), (this._timeout = 0), (this._isHovered = !1), (this._activeTrigger = {}), (this._popper = null), (this._templateFactory = null), (this._newContent = null), (this.tip = null), this._setListeners();
    }
    static get Default() {
      return on;
    }
    ...
    toggle(t) {
      if (this._isEnabled) {
        if (t) {
          ...
          return (e._activeTrigger.click = !e._activeTrigger
            .click), void (e._isWithActiveTrigger() ? e._enter() : e._leave());
        }
    ...
    dispose() {
      clearTimeout(
        this._timeout
      ), P.off(this._element.closest(Zi), tn, this._hideModalHandler), this.tip && this.tip.remove(), this._disposePopper(), super.dispose();
    }
    show() {
    ...
    _createTipElement(t) {
      ...
      return e.setAttribute(
        "id",
        i
      ), this._isAnimated() && e.classList.add(Gi), e;
    }
    setContent(t) {
      ...
      for (const e of t)
        if ("click" === e)
          ...
          P.on(this._element, t, this._config.selector, t => {
            ...
            const e = this._initializeOnDelegatedTarget(t);
            (e._activeTrigger[
              "focusout" === t.type ? nn : en
            ] = e._element.contains(t.relatedTarget)), e._leave();
          });
        }
      (this._hideModalHandler = () => {
        this._element && this.hide();
      }), P.on(this._element.closest(Zi), tn, this._hideModalHandler), this._config.selector ? (this._config = { ...this._config, trigger: "manual", selector: "" }) : this._fixTitle();
    }
    _fixTitle() {
    ...
    _configAfterMerge(t) {
      return (t.container =
        !1 === t.container
          ...
          : r(
              t.container
            )), "number" == typeof t.delay && (t.delay = { show: t.delay, hide: t.delay }), (t.originalTitle = this._element.getAttribute("title") || ""), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), t;
    }
    _getDelegateConfig() {
      const t = {};
  ...
  class On extends z {
    constructor(t) {
      super(
        t
      ), (this._parent = this._element.closest('.list-group, .nav, [role="tablist"]')), this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), P.on(this._element, "keydown.bs.tab", t => this._keydown(t)));
    }
    static get NAME() {
      return "tab";
    }
    ...
    _toggleDropDown(t, e) {
      ...
      n(
        ".dropdown-toggle",
        wn
      ), n(".dropdown-menu", En), n(".dropdown-item", wn), i.setAttribute("aria-expanded", e);
    }
  ...
  P.on(document, "click.bs.tab", Tn, function(t) {
    ["A", "AREA"].includes(this.tagName) &&
      t.preventDefault(), l(this) || On.getOrCreateInstance(this).show();
  ...
  class In extends z {
    ...
    show() {
      P.trigger(this._element, "show.bs.toast").defaultPrevented ||
        (
          ...
          this._queueCallback(
            () => {
              this._element.classList.remove(Ln), P.trigger(
                this._element,
                "shown.bs.toast"
      ...
      this.isShown() &&
        (P.trigger(this._element, "hide.bs.toast").defaultPrevented ||
          (
            ...
            this._queueCallback(
              () => {
                this._element.classList.add(xn), this._element.classList.remove(
                  Ln,
                  kn
    ...
    _setListeners() {
      ...
      ), P.on(this._element, "mouseout.bs.toast", t => this._onInteraction(t, !1)), P.on(this._element, "focusin.bs.toast", t => this._onInteraction(t, !0)), P.on(this._element, "focusout.bs.toast", t => this._onInteraction(t, !1));
    }
    _clearTimeout() {
  ...
  return R(
    In
  ), g(In), { Alert: q, Button: K, Carousel: at, Collapse: pt, Dropdown: li, Modal: Si, Offcanvas: Bi, Popover: hn, ScrollSpy: mn, Tab: On, Toast: In, Tooltip: an };
});
