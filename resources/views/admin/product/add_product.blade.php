                    ...
                    <form action="{{ URL::to('admin/products/save') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 form-group">
                                ...
                                <input type="text" class="form-control" name="item_name[ar]"
                                    value="{{ old('item_name.ar') }}" placeholder="{{ trans('labels.name_ar') }}" required>
                            ...
                            <div class="col-12 col-lg-6 form-group">
                                ...
                                <input type="text" class="form-control" name="item_name[en]"
                                    value="{{ old('item_name.en') }}" placeholder="{{ trans('labels.name_ar') }}" required>
                                @if ($errors->has('item_name.en'))
                                    <div class="alert alert-danger">{{ $errors->first('item_name.en') }}</div>
                                @endif
                            </div>
                            <div class="col-12 col-lg-6 form-group">
                                <label class="form-label">{{ trans('labels.description_ar') }} <span class="text-danger"> *
                                    </span></label>
                                <textarea name="description[ar]" class="form-control" rows="3" placeholder="{{ trans('labels.description_ar') }}"
                                    required>{{ old('description.ar') }}</textarea>
                                @if ($errors->has('description.ar'))
                                    <div class="alert alert-danger">{{ $errors->first('description.ar') }}</div>
                                @endif
                            </div>
                            <div class="col-12 col-lg-6 form-group">
                                <label class="form-label">{{ trans('labels.description_en') }} <span class="text-danger"> *
                                    </span></label>
                                <textarea name="description[en]" class="form-control" rows="3" placeholder="{{ trans('labels.description_en') }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group">
                                        without time
                                        <input id="checkbox-switch" type="checkbox" class="checkbox-switch"
                                            name="remove_time" value="1">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row dn mt-4 @if ($errors->has('variants_name.*') || $errors->has('variants_price.*')) dn @endif @if (old('variants') == 2) d-flex @endif"
                                    id="price_row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="extras_name[0][ar]"
                                            placeholder="{{ trans('labels.name_ar') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="col-form-label">{{ trans('labels.name_en') }}</label>
                                        <input type="text" class="form-control" name="extras_name[0][en]"
                                            placeholder="{{ trans('labels.name_en') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
