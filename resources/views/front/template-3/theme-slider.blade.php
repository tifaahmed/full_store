...
<section  id="tab-category_{{$category->id}}" class="theme3pruductgrid px-0">
     ...
     <div id="product_items-{{ $category->id }}" class="row border-bottom owl-carousel product-items  owl-theme" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">
