...
<div id="{{$category->slug}}">
     ...
     <div id="product_items-{{ $category->id }}" class="row theme-4-gridproduct-card g-2 g-md-3 owl-carousel product-items  owl-theme">
                               ...
                               <div class="row justify-content-between align-items-center gx-0">
                                   ...
                                   <div class="col-3 col-md-2 d-flex justify-content-end px-2 mb-2 mb-md-0">
                                       ...
                                       @else
                                           ...
                                           <a type="button" class="btn-plus-1 addcartbtn-{{$item->id}}"  onclick="addtocart('{{ $item->id }}','{{$item->item_name}}','{{$item->item_price}}','{{$image}}','{{$item->tax}}','1','{{$item->item_price}}')">
