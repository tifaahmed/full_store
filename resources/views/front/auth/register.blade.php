    ...
    <div class="container">
        ...
        <div class="py-4">
            ...
            ">
                ...
                <div class="col-md-12 col-lg-12 pb-12 px-0 {{session()->get('direction') == 2 ? 'ps-lg-5 ' : 'pe-lg-5 '}}">
                            ...
                            <form action="{{ URL::to($storeinfo->slug . '/register_customer/') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <input type="email" class="form-control input-h" id="email" name="email"  value="{{old('email')}}" placeholder="{{ trans('labels.email') }} "  required>
                                        @error('email')
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input   class="form-control input-h" id="name" name="name"  value="{{old('name')}}" placeholder="{{ trans('labels.name') }} "  required>
                                        @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                            ...
                                            <li class="list-group-item p-2 border-top-0" data-bs-dismiss="offcanvas">
                                                ...
                                                href="#">
                                                    ...
                                                    text-align: center;">
                                                        ...
                                                        {{ trans('labels.continue_with_apple') }}
                                                    </p>
                                                </a>
                                            </li>
                                            <li class="list-group-item p-2 border-top-0" data-bs-dismiss="offcanvas">
                                                ...
                                                href="#">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="10px" width="25" height="25" viewBox="0 0 48 48">
                                                        ...
                                                        {{ trans('labels.continue_with_google') }}
                                                    </p>
                                                </a>
                                            </li>
                                        </ul>
