                    ...
                    <div class="row align-items-center py-3" >
                            ...
                            <form action="{{ URL::to($storeinfo->slug . '/checklogin-normal') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <input type="password" class="form-control input-h" name="password" value="{{old('password')}}" placeholder="{{ trans('labels.password') }}"  required>
                                        @error('password')
                                        <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12 row mb-4" style="text-align: center">
                                        <p>
                                            {{ trans('labels.new_to_store?') }}
                                            <a href="{{ URL::to($storeinfo->slug . '/register/') }}" 
