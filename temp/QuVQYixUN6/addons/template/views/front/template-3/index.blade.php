                        ...
                        <div class="card-body">
                            <div class="d-block d-md-flex d-lg-block d-xl-flex align-items-center">
                                <a href="#" class="theme-3-logo">
                                    <img src="{{ helper::image_path(helper::appdata(@$storeinfo->id)->logo) }}" alt="" class="rounded-3">
                                </a>
                                <div class="w-100">
                                    <h5 class="mb-3 px-3 {{session()->get('direction') == 2 ? 'text-center text-md-end text-lg-center text-xl-end' : 'text-center text-md-start text-lg-center text-xl-start'}}">
                                        {{ @$storeinfo->name }}
                                    </h5>
                                    <div class="peyment-overflow d-flex">
                                        ...
                                        <i class="fa-solid  {{session()->get('direction') == 2 ? 'fa-chevron-left' : 'fa-chevron-right'}} d-none d-lg-none d-md-block d-xl-block"></i>
                                    </div>
...
<div class="offcanvas {{session()->get('direction') == 2 ? 'offcanvas-end' : 'offcanvas-start'}} categoriesoffcanvastheme-4" tabindex="-1" id="offcanvasinfo" aria-labelledby="offcanvasinfo">
    ...
    <div class="offcanvas-body p-0">
                            ...
                            <div class="w-100 mx-3">
                                ...
                                <div class="row g-2 align-items-center justify-content-between theme-4-contactinfo">
                                    <div class="col col-md-6">
                                        <a href="tel:{{ helper::appdata($storeinfo->id)->contact }}" class="btn btn-outline-dark w-100 d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="col col-md-6">
                                        <a href="mailto:{{ helper::appdata($storeinfo->id)->email }}" class="btn btn-outline-dark w-100 d-flex align-items-center justify-content-center">
        ...
        <ul class="list-group theme-3-store-infos-list">
            <a class="list-group-item rounded-0 d-flex align-items-center gap-2" href="https://www.google.com/maps/place/323/{{ helper::appdata($storeinfo->id)->address }}">
                <i class="fa-solid fa-location-dot"></i>
                <span class="w-100">
                    <p class="px-2 fw-400 w-100 d-flex gap-1 align-items-center">{{ helper::appdata($storeinfo->id)->address }}</p>
                </span>
            </a>
            <a class="list-group-item rounded-0 d-flex align-items-center gap-2" href="tel:{{ helper::appdata($storeinfo->id)->contact }}">
            ...
            <a class="list-group-item rounded-0 d-flex align-items-center gap-2" href="mailto:{{ helper::appdata($storeinfo->id)->email }}">
            ...
            @endphp
            @if($blog == 1)
            <a class="list-group-item rounded-0 d-flex align-items-center gap-2" href="{{ URL::to(@$storeinfo->slug . '/blog-list') }}">
            ...
            <a class="list-group-item rounded-0 d-flex align-items-center gap-2"  href="{{ URL::to(@$storeinfo->slug . '/aboutus') }}">
                <i class="fa-regular fa-file-lines"></i>
                <p class="px-2 fw-400">{{ trans('labels.about_us') }}</p>
            </a>
            <a class="list-group-item rounded-0 d-flex align-items-center gap-2" href="{{ URL::to(@$storeinfo->slug . '/contact') }}">
                <i class="fa-regular fa-address-card"></i>
                <p class="px-2 fw-400">{{ trans('labels.contact_us') }}</p>
            </a>
            <a class="list-group-item rounded-0 d-flex align-items-center gap-2" href="{{ URL::to(@$storeinfo->slug . '/terms_condition') }}">
                <i class="fa-regular fa-note-sticky"></i>
                <p class="px-2 fw-400">{{ trans('labels.terms') }}</p>
            </a>
            <a class="list-group-item rounded-0 d-flex align-items-center gap-2" href="{{ URL::to(@$storeinfo->slug . '/privacypolicy') }}">
            ...
            <a class="list-group-item rounded-0 d-flex align-items-center gap-2" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#subscribe_modal">
                ...
                <p href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#subscribe_modal" class="px-2 fw-400">{{ trans('labels.subscribe') }}</p>
            </a>
        </ul>
    </div>
